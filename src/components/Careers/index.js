...
const Careers = () => {
    ...
    content:"A MERN stack developer is responsible for creating full-stack web applications using MongoDB, Express.js, React, and Node.js. They design and implement user interfaces with React for front-end functionality, ensuring scalability and responsiveness.",
    ...
    role:"A MERN stack developer is responsible for developing and maintaining web applications using the MongoDB, Express.js, React, and Node.js technologies. They collaborate with other team members to design and implement features, ensuring the application is responsive, efficient, and scalable. MERN stack developers also troubleshoot and debug issues, optimize performance, and stay updated with the latest trends and technologies in web development."    
},
    {
...
role:"As a Full-Stack Developer, your primary role will be to develop and maintain both the front-end and back-end of web applications. This includes collaborating with designers and product managers to translate requirements into technical specifications and writing clean, efficient code using languages like HTML, CSS, JavaScript, and frameworks such as React, Angular, or Vue.js. You will also be responsible for implementing responsive designs, optimizing databases."
    ...
    content:"A Business Development Executive (BDE) is a professional responsible for identifying new business opportunities, building client relationships, and expanding the company's market presence.",
                        ...
                        {careers.map(each => (
                            <div key={each.domain} className="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                                <div style={{ background: "white" }} className="course-item mb-2">
                                    <img style={{ width: "100%" }} src={each.img} className="img-fluid" alt="" />
                                    <div className="course-content">
                                        ...
                                        <div className="trainer d-flex justify-content-between align-items-center">
                                            ...
                                            <div className="trainer-rank d-flex align-items-center">
                                                ...
                                                <Button><Link to={`/apply/${each.domain}`}>Apply</Link></Button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
